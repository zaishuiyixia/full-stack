...
async function send(sendInfo) {
  ...
  let transporter = nodemailer.createTransport({
    ...
    auth: {
      user: '1720966051@qq.com', // generated ethereal user
      pass: 'wcabfwqzqxbwbgfh', // generated ethereal password
    },
  })
  ...
  let info = await transporter.sendMail({
    from: '"认证邮件" <1720966051@qq.com>', // sender address
